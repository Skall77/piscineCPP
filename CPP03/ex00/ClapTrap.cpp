...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/04/01 10:25:09 by aaudevar          #+#    #+#             */
/*   Updated: 2023/04/01 10:25:53 by aaudevar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::takeDamage(unsigned int amount)
{
	...
	std::cout << " points of damage, he have " << this->_hit_point;
...
void ClapTrap::beRepaired(unsigned int amount)
{
	if (this->_energy_point > 0 && this->_hit_point > 0)
	{
		...
		std::cout << " hit points, he now have " << this->_hit_point;
